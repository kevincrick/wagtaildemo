...
class CodeBlock(blocks.StructBlock):
    ...
    style = blocks.ChoiceBlock(choices=STYLE_CHOICES, default='prettyprint')
    code = blocks.RichTextBlock()

    class Meta:
        icon = 'code'


# Streamfield blocks are grouped here
# This is called in body = StreamField(DemoStreamBlock())        
...
# Add Tags to Snippets in admin
@register_snippet
class Tag(TaggitTag):
    class Meta:
        proxy = True

# Add Adverts to Snippets in admin
...
class BlogPage(Page):
    ...
    categories = ParentalManyToManyField('demo.BlogCategory', blank=True)
